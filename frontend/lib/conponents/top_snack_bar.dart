...
import 'package:frontend/conponents/tap_bounce_container.dart';
import 'package:frontend/conponents/safe_area_values.dart';
...
class _TopSnackBarState extends State<_TopSnackBar>
  ...
  Widget build(BuildContext context) {
    return Positioned(
      top:
          widget.snackBarPosition == SnackBarPosition.top
              ? widget.padding.top
              : null,
      bottom:
